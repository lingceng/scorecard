...
assert.equal(award([[-2, -2, -2, 6]], [null], 3, 0).awarded, false)
...
assert.equal(award([[-2, -2, -2, 6]], [{ type: 'bomb', winner: 3, rate: 2 }], 3, 0).awarded, false)
...
console.log('game-rules: 9 assertions passed')
